...
this is a smart public transport advisor for the group project of COMP1110.
it is completely coded in python
execution: download files and run main.py in pycharm or any other python IDE
file structure: /MTR_Project
│
